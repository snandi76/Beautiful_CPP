...
// serializeDlg.cpp : implementation file
//
...
CserializeDlg::CserializeDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_SERIALIZE_DIALOG, pParent)
{
...
// CserializeDlg message handlers
...
void CserializeDlg::OnBnClickedButton1()
{
	...
	//PdataInfo obj(_T("Bababn"), 27);
	PdataInfo obj;
	CFile file;
	file.Open(_T("c:\\test.txt"), CFile::modeRead/*Write | CFile::modeCreate*/);
	CArchive ar1(&file, CArchive::load);
	obj.Serialize(ar1);

	CString cstroutput = obj.m_cstrName;
	unsigned int iAge = obj.m_iAge;

...
BEGIN_MESSAGE_MAP(CMFCServerApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CMFCServerApp::OnAppAbout)
...
void CMFCServerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CMFCServerApp customization load/save methods
...
void CMFCServerApp::SaveCustomState()
{
}

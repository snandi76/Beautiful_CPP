========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLComApp Project Overview
========================================================================

AppWizard has created this ATLComApp project for you to use as the starting point for
...
ATLComApp.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLComApp.h)
        GUID definitions                                (ATLComApp_i.c)
        A type library                                  (ATLComApp.tlb)
        Marshaling code                                 (ATLComApp_p.c and dlldata.c)

ATLComApp.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLComApp.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLComApp.pch and a precompiled types file named StdAfx.obj.
...
ATLComAppps.vcxproj
	...
	dlldata.c, ATLComApp_i.c and ATLComApp_p.c which are required
	to build the proxy/stub DLL.

ATLComAppps.vcxproj.filters
